resource "aws_iam_role" "ecs-service-role" {
  name = "flamboyant-ECS-Service-Role-${var.environment}"
...
resource "aws_iam_role" "ecs-instance-role" {
  name = "flamboyant-${var.environment}-ecs-instance-role"
  path = "/"
...
resource "aws_iam_instance_profile" "ecs-instance-profile" {
  name = "flamboyant-${var.environment}-ecs-instance-profile"
  path = "/"
...
resource "aws_iam_policy" "app_bucket_policy" {
  name = "flamboyant-s3-policy-${var.environment}"
