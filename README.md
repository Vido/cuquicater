...
```bash
$ pyenv virtualenv 3.8.0 <flamboyant>
$ pyenv activate <flamboyant>
...
- `AWS_RESOURCE_NAME_PREFIX` (ex: `flamboyant-backend`)
- `AWS_SERVICE_NAME_LAB` (ex: `flamboyant-backend-lab`)
- `AWS_SERVICE_NAME_STAGING` (ex: `flamboyant-backend-staging`)
- `AWS_SERVICE_NAME_PROD` (ex: `flamboyant-backend-production`)
- `AWS_CLUSTER_NAME_LAB` (ex: `flamboyant-lab`)
- `AWS_CLUSTER_NAME_STAGING` (ex: `flamboyant-staging`)
- `AWS_CLUSTER_NAME_PROD` (ex: `flamboyant-production`)
